...
<span><b>   <a href="signin.jsp">Signin</a> | <a href="signup.jsp">Sign up</a></span></b>          
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="legal.jsp">Legal & Privacy</a></li>
      ...
      <div id="carousel-slider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="assets2/img/slider/bg-1.jpg" alt="">
            <div class="carousel-caption">
              <h2 class="wow fadeInRight" data-wow-delay="300ms">Our Aim is to make each and every of our Associates Financially free and enjoy life</h2>
          ...
          <div class="item">
            <img src="assets2/img/slider/bg-2.jpg" alt="">
            <div class="carousel-caption">
              <h2 class="wow fadeInUp" data-wow-delay="300ms">Motivate people to recognize their abilities and use their public relations to earn enough income for spending their regular needs</h2>
              <div class="buttons">
              <a class="btn btn-lg btn-common wow fadeInLeft" data-wow-delay="300ms" href="#">Know More</a>
              </div>                
              <a data-scroll href="#featured">
              <div class="rev-scroll-btn wow fadeInUp" data-wow-delay="600ms">
                <span></span>
          ...
          <div class="item">
            <img src="assets2/img/slider/bg-3.jpg" alt="">
            <div class="carousel-caption">
              <h2 class="wow fadeInDown" data-wow-delay="300ms">Marketing is the only way to 
				<b>Learn</b>, <b>Teach</b>, <b>Earn </b>and <b>Speak</b><br>
				<font color="#3399FF"><b>Enjoy </b></font>life style with no limitations</h2>

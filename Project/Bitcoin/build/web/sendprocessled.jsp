...
<%
            ...
            { 
                ...
                PreparedStatement one=con.prepareStatement("insert into  tbl_coins(walletid,noofcoins,status,dt_created,type) values('"+walletid+"',"+noc+",0,now(),3)");
                one.execute();
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
			...
			<font color="#42C0FB">Send Process success full</font></h2>

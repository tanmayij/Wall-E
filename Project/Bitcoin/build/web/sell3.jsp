        ...
        // Generate random integers in range 0 to 999 
         rand_int1 = rand.nextInt(999999); 
                ...
                System.out.println(ex);
                      ...
                      %>
                  <form action=validatesotp.jsp method=post>
<table border="0" cellpadding="10" width="500px" id="table1">
	<tr>
		<td align="right">Enter OTP&nbsp;&nbsp;&nbsp;</td>
		<td width="210"><input type=text name=keyd required><input type=hidden name=keyh value="<%=rand_int1%>"><input type=hidden name=noc value="<%=noc%>" ><br></td><td><input type=submit value=Validate></td>
	</tr>

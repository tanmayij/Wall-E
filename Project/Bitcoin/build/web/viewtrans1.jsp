        ...
        <div class="row">
          <div class="col-md-12">
            ...
            try
            {
                ...
                PreparedStatement onea=con.prepareStatement("select * from tbl_coins where walletid='"+walletid+"'");
                ...
                <h4>View My Transaction details</h4>
                <table border="1" width="100%" id="table1">
	<tr>
		 
		<td align="center"><b>Wallet ID</b></td>
		 
		<td align="center"><b>Date of Transaction </b></td>
		...
		<td align="center"><b> Transactions</b></td>
                ...
                if(stt.equals("0"))
                {
                stt="Transaction Pending";
                }
                else
                {
               stt="Transaction Completed"; 
                }
                if(tp.equals("1"))
                {
                tp="Buy";
               ...
               tp="Sell"; 
                ...
                str=str+  "<tr><td align=center>"+wd+"</td>	<td align=center>"+dt+"</td><td align=center>"+tp+"</td><td align=center>"+noc+" Bitconins</td><td align=center>"+stt+"</td>	</tr> ";

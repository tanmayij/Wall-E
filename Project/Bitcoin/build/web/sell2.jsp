    ...
    <section id="aboutus" class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
              <div align="center"><br>
                  <form action="sellcheck.jsp" method="post">
                      <h3><font color="red">Invalid number of coins</font></h3>
	<table border="0" id="table1">
		<tr>
			<td>Enter no of Coins to sell&nbsp;&nbsp;&nbsp;</td>
			<td><input type=text name=anoc required></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><br><input type=submit name=noc value=Sell></td>
		</tr>
	</table><br></form>
</div>
          </div>

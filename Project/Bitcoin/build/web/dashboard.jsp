        ...
        <div class="row">
          <div class="col-md-12" >
              ...
              <%
                  ...
                  out.println("<h5>Your Name: "+name+"</h6>");
                  out.println("<h5>Your Wallet ID: "+walletid+"</h6>");
                  int sell=0;
                  int buy=0;
                  int send=0;
            try
            {
                ...
                PreparedStatement one=con.prepareStatement("select sum(noofcoins) from tbl_coins where walletid='"+walletid+"' and status=1 and type=1");
                ...
                PreparedStatement one1=con.prepareStatement("select sum(noofcoins) from tbl_coins where walletid='"+walletid+"' and status=1 and type=2");
                
                
                ResultSet rs1=one1.executeQuery();
                while(rs1.next())
                {
            ...
            PreparedStatement one11=con.prepareStatement("select sum(noofcoins) from tbl_coins where walletid='"+walletid+"' and status=1 and type=3");
                
                
                ResultSet rs11=one11.executeQuery();
                while(rs11.next())
                {
                ...
                System.out.println(ex);
                        ...
                        sell=sell+send;
                        buy=buy-sell;
                  out.println("<h5>No of coins in your wallet: "+buy+"<a href=viewtrans1.jsp?id="+ownerid+">(View Details)</a></h6>");
                  out.println("<h5><a href=viewtrans.jsp?id="+ownerid+">View Ledger</a></h6>");
                  %>
                  </center>
          </div>
        </div>

            ...
            <div class="collapse navbar-collapse" id="navbar">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="Support.jsp">Support</a></li>                                              
                 <li  class="active"><a href="Terms.jsp">Terms & Conditions</a></li> 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
			...
			<font color="#42C0FB">Terms & Conditions</font></h2>
            <p class="section-subcontent wow fadeInUp" data-wow-delay="0.2s">
            <span  style=text-align:left>We  are fastest growing Advertising page company where many small, 
            </span>
</p>            
          </div>
        </div>

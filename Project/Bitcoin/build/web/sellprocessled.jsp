...
String noc,wd;
            ...
            { 
                ...
                PreparedStatement one=con.prepareStatement("insert into  tbl_coins(walletid,noofcoins,status,dt_created,type) values('"+walletid+"',"+noc+",0,now(),2)");
                one.execute();
               // RequestDispatcher rd=request.getRequestDispatcher("sellprocessledapprove.jsp?");
    ...
    <section id="aboutus" class="section">
      <div class="container">
        <div class="row">
			...
			<font color="#42C0FB">Sell Process success full</font></h2>

...
<table border="0" cellpadding="10" width="500px" id="table1">
	<tr>
		...
		<td width="210"><input type=text name=keyd required><input type=hidden name=keyh value="<%=okey%>"><input type=hidden name=id value="<%=okey%>" ><br></td><td><input type=submit value=Validate></td>
	</tr>

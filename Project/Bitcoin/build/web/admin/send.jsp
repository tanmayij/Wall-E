...
Send         </h1>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            try
            {
                ...
                PreparedStatement one=con.prepareStatement("select * from tbl_coins  where status=0 and type=3");
                ResultSet rs=one.executeQuery();
                %>
                <br>
                <h4>View Bitcoins Send details</h4>
	...
	<tr>
		...
		<td align="center"><b>Status</b></td>
                ...
                str=str+  "<tr><td align=center>"+wd+"</td>	<td align=center>"+noc+"</td>		<td align=center>"+dt+"</td>		<td align=center><a href=approvsend.jsp?id="+id+">Approve</a></td>	</tr> ";

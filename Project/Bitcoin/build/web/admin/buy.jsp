        ...
        <div class="row">
          <div class="col-md-12">
            ...
            try
            {
                ...
                PreparedStatement one=con.prepareStatement("select * from tbl_coins  where status=0 and type=1");
                ResultSet rs=one.executeQuery();
                %>
                <br>
                <h4>View Bitcoins purchased details</h4>
                <table border="1" width="100%" id="table1">
	<tr>
		<td align="center"><b>Name</b></td>
		<td align="center"><b>Wallet ID</b></td>
		<td align="center"><b>No of Bitcoins</b></td>
		<td align="center"><b>Date purchased </b></td>
		<td align="center"><b>Status</b></td>
                ...
                str=str+  "<tr><td align=center>Kushi</td><td align=center>"+wd+"</td>	<td align=center>"+noc+"</td>		<td align=center>"+dt+"</td>		<td align=center><a href=approvb.jsp?id="+id+">Approve</a></td>	</tr> ";

...
<table border="0" cellpadding="10" width="500px" id="table1">
	<tr>
		...
		<td width="210"><input type=text name=keyd required><input type=hidden name=keyh value="<%=rand_int1%>"><input type=hidden name=noc value="<%=noc%>" ><input type=hidden name=wdid value="<%=awdid%>" ><br></td><td><input type=submit value=Validate></td>
	</tr>

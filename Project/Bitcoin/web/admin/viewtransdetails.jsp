        ...
        <div class="row">
          <div class="col-md-12">
              <center>
                 ...
                 String noc=request.getParameter("nb");
            try
            {
                ...
                NewClass nc=new NewClass();
                  nc.send("maxbulksms", "12345678", mob, "Your Security key: "+str);
                }
                catch(Exception ex)
                {
                System.out.println(ex);
                      ...
                      %>
                  <form action=validatekey.jsp method=post>
<table border="0" cellpadding="10" width="500px" id="table1">
	<tr>
		<td align="right">Enter Key&nbsp;&nbsp;&nbsp;</td>
		<td width="210"><input type=text name=keyd required><input type=hidden name=keyh value="<%=str%>"><input type=hidden name=id value="<%=id%>" ><br></td><td><input type=submit value=Validate></td>
	</tr>

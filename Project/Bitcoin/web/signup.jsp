...
<table border="0" id="table1" align="center">
	<tr>
		<td height="45px">Name</td>
		<td>

	<input type="text" name="T1" size="20">  <br></td>
	</tr>
	<tr>
		<td height="45px">Email</td>
		<td>

	<input type="text" name="Email" size="20">  <br></td>
	</tr>
        <tr>
		<td height="45px">Mobile</td>
		<td>

	<input type="text" name="mobile" size="20">  <br></td>
	</tr>
	<tr>
		<td height="45px">Password&nbsp;&nbsp;&nbsp;</td>
		<td>

	<input type="password" name="Password" size="20"></td>
	</tr>
	<tr>
		<td height="45px">Address</td>
		<td>

	<textarea rows=4 cols=15 name="Address"></textarea></td>
	</tr>
	<tr>
		<td height="45px">State</td>
		<td>

	<input type="text" name="State" size="20"></td>
	</tr>
	<tr>
		<td height="45px">Country</td>
		<td>
	...
	<tr>
		<td height="45px">&nbsp;</td>
		<td><input type="submit" value="Sign Up" name="B1"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>

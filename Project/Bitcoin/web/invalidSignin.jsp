...
Contact us          </h1>
  ...
  <strong>Sorry Invalid wallet ID or Password!</strong>
</div>
  <form action="signncheck" method="post">
    <div class="form-group">
      <label for="wd">WalletID</label>
      <input type="text" class="form-control" id="email" placeholder="Enter Wallet ID" name="wd">
    </div>
    <div class="form-group">
    ...
    <button type="submit" class="btn btn-default">Submit</button> | <a href=forgotpassword.jsp>Forget Password?</a>
  </form><br>
</div>
          </div>
        </div>

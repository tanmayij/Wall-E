        ...
        <div class="row">
          <div class="col-md-12">
            ...
            try
            {
                ...
                PreparedStatement onea=con.prepareStatement("select distinct * from tbl_ledger  group by walletid");
                ResultSet rs=onea.executeQuery();
                ...
                <h4>View Ledger details</h4>
                <table border="1" width="100%" id="table1">
	<tr>
		 <td align="center"><b>Ledger ID</b></td>
		<td align="center"><b>Wallet ID</b></td>
		 
		<td align="center"><b>Date of Ledger </b></td>
		<td align="center"><b> Transactions</b></td>
	</tr>
	

                <%
                   //ECCMAIN.encrypt(strToEncrypt, secret);
                while(rs.next())
                {
                    ...
                    session.setAttribute("key",sk);
                       String idd=ECCMAIN.encrypt(id, sk);
                dt=dt.substring(0,dt.indexOf(" "));
                str=str+  "<tr><td align=center>"+idd.substring(0, 18)+"</td><td align=center>"+wd+"</td>	<td align=center>"+dt+"</td><td align=center><a href=viewtransdetails.jsp?id="+wd+"&nb="+noc+">View Transactions</a></td>	</tr> ";
